...
export default function Hero() {
  return (
    <section className="relative flex min-h-[calc(100vh-3.5rem)] items-center overflow-hidden bg-white dark:bg-gray-900">
      <GridBackground />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="flex-1 text-center lg:text-left">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-gray-900 dark:text-white leading-[1.1]"
            >
            ...
            <motion.p
              ...
              className="mt-6 max-w-xl text-lg text-gray-600 dark:text-gray-300 leading-relaxed lg:mx-0 mx-auto"
            >
            ...
            >
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-brand-700 px-6 py-3.5 text-sm font-semibold text-white hover:bg-brand-700 dark:bg-brand-700 dark:hover:bg-brand-600 transition-all shadow-lg shadow-brand-200/50 dark:shadow-brand-900/30 hover:shadow-xl hover:shadow-brand-300/50 dark:hover:shadow-brand-800/40 hover:-translate-y-0.5"
              >
              ...
              <Link
                href="/cv/automation"
                className="inline-flex items-center gap-2 rounded-xl border-2 border-gray-200 dark:border-gray-700 px-6 py-3.5 text-sm font-semibold text-gray-700 dark:text-gray-300 hover:border-brand-300 dark:hover:border-brand-600 hover:text-brand-700 dark:hover:text-brand-400 transition-all hover:-translate-y-0.5"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-48 h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 rounded-full bg-gradient-to-br from-brand-600 to-teal-500 dark:from-brand-700 dark:to-teal-600 flex items-center justify-center shadow-2xl shadow-brand-300/30 dark:shadow-brand-900/40 border-4 border-white dark:border-gray-800">
                <span className="text-6xl sm:text-7xl font-bold text-white/90 select-none">DB</span>
              </div>
              <div className="absolute -bottom-1 -right-1 bg-white dark:bg-gray-800 rounded-full px-3 py-1 shadow-lg border border-gray-100 dark:border-gray-700">
